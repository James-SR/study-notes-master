...
```{r bootstrap, echo = FALSE, fig.cap='Illustration of the bootstrap approach on a small sample containing n = 3 observations [@ISLR2013, pg 190]'}
...
So the variability - the standard error or SE - of $\hat{p}*$ is 0.0841.  We can now use this SE to calculate 
