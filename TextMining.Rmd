...
We could create a pyramid plot.  The process is the same as before - paste, collapse and combine c() our corpora.  However, for pyramid plots we use subsetting to identify what each document shares.  

Finally we could create a word network.  
